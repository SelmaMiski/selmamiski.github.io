...
const translations = {
  en: {
    ...
    summary_why_text: "Languages: Italian, English, French, Spanish, Arabic. Design tools: Adobe Creative Suite and Canva. Web skills: HTML and Java, WordPress website managementDigital Tools: Meta Business Suite, Google Ads, Google Analytics, SEO.",
